        ...
        <div className="container">
         <div className="footer-cta pt-5 pb-5">
                <div className="row">
                    ...
                    <div className="single-cta animate-cta" style={{ animationDelay: '0s' }}>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12 col-12 mb-30">
                    <div className="single-cta animate-cta" style={{ animationDelay: '0.15s' }}>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12 col-12 mb-30">
                    <div className="single-cta animate-cta" style={{ animationDelay: '0.3s' }}>
